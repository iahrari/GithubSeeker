 ...
 */
    (context: Context, orientation: Int, private var leftPadding: Int) : RecyclerView.ItemDecoration() {
    ...
    init {
        leftPadding = (leftPadding *context.resources.displayMetrics.density + 0.5).toInt()
